...
![Native dir](dir-native.png)

Next, we use the `HEXDUMP` program to dump the file `"$"`.

![hexdump dir](dir-hexdump.png)

We indeed see, at file offset $0000 and $0001, that the load address is $0401.
